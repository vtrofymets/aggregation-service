...
public class ClientsHealthIndicatorTest extends AbstractIntegrationTest {
    ...
    void checkDataSourceHealth() throws Exception {
        var contentAsString = mockMvc.perform(MockMvcRequestBuilders.get("/actuator/health/clients"))
